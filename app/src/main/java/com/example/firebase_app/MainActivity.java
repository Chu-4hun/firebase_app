...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(view -> {
            ...
            database = FirebaseDatabase.getInstance("https://fir-app-c88b7-default-rtdb.firebaseio.com/")
            ...
            database.child(phone).setValue(user).addOnSuccessListener(new OnSuccessListener<Void>() {
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(getApplicationContext(), "Произвошла ошибка", Toast.LENGTH_LONG).show();
                    ;
                }
            });
        });
